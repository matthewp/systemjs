...
SystemJS = meta register core global cjs amd map plugins bundles depCache
SystemCSP = scriptLoader meta register core global cjs amd map plugins bundles depCache
